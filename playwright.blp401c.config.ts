...
/**
 * BL-P4-01c isolierte E2E-Suite: Preislisten-Jahreswahl im Wizard.
 * Eigene SQLite-DB, Port 8019 — niemals Dev-DB `dispo`.
 */
...
const e2ePort = process.env.E2E_BLP401C_PORT ?? '8019';
