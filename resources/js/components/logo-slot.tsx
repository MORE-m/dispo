    ...
    if (logoPath) {
        const image = (
            <img
                ...
                className={cn(
                    ...
                    variant === 'card' && 'max-h-[5.25rem] w-auto max-w-[92%]',
                )}
            />
        );
        ...
        if (variant === 'card') {
            return (
                <span
                    className={cn(
                        'bg-background border-border/70 flex h-24 w-full shrink-0 items-center justify-center rounded-lg border p-3',
                        className,
                    )}
                >
                    {image}
    ...
    return (
        <span
            ...
            className={cn(
                ...
                variant === 'inline' && 'size-8',
                variant === 'card' && 'h-24 w-full text-sm',
                className,
            )}
            title={name}
        >
