...
/**
 * DF-3.3a2β isolierte E2E-Suite: eigene SQLite-DB und eigener Port.
 */
const e2eDb = path.resolve(
    path.dirname(fileURLToPath(import.meta.url)),
    'database/e2e-df33a2b.sqlite',
);

const e2ePort = process.env.E2E_DF33A2B_PORT ?? '8005';
