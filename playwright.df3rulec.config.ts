...
/**
 * DF-3-RULE-C isolierte E2E-Suite (Regel-Editor).
 * Eigene SQLite-DB, Port 8015 — nicht in der Hauptsuite.
 */
const e2eDb = path.resolve(
    path.dirname(fileURLToPath(import.meta.url)),
    'database/e2e-df3rulec.sqlite',
);

const e2ePort = process.env.E2E_DF3RULEC_PORT ?? '8015';
