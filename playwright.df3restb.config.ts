...
/**
 * DF-3-REST-B isolierte E2E-Suite (eigene SQLite-DB, Port 8013).
 */
const e2eDb = path.resolve(
    path.dirname(fileURLToPath(import.meta.url)),
    'database/e2e-df3restb.sqlite',
);

const e2ePort = process.env.E2E_DF3RESTB_PORT ?? '8013';
