...
/**
 * BL-P4-01b isolierte E2E-Suite: Preislisten-Excel-Import.
 * Eigene SQLite-DB, Port 8018 — niemals Dev-DB `dispo`.
 */
const e2eDb = path.resolve(
    path.dirname(fileURLToPath(import.meta.url)),
    'database/e2e-bl-p4-01b.sqlite',
);

const e2ePort = process.env.E2E_BLP401B_PORT ?? '8018';
