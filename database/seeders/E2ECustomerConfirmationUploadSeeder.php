...
class E2ECustomerConfirmationUploadSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $organization = Organization::factory()->create(['name' => 'E2E BL-P9-01a']);
        ...
        $list = PriceList::factory()->create([
            ...
            'year' => $year,
            'version' => 'e2e-blp901a-'.$inventory->code,
        ...
        foreach ([
            ...
            $order = $dispoWriter->createFromCalculation($calc, $positionIds, $sales)->order;
            $orders[$key] = [
                'id' => $order->id,
                'number' => $order->number,
            ];
        ...
        // draft = Alias für draftUpload (einfache Suite-Referenz)
        $orders['draft'] = $orders['draftUpload'];

        File::put(
            database_path('e2e-bl-p9-01a-orders.json'),
