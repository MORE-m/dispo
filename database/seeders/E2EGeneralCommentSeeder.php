...
/**
 * E2E-Seeder BL-P9-02a allgemeine Kommentare (Port 8043).
 */
class E2EGeneralCommentSeeder extends Seeder
{
    public function run(): void
    {
        ...
        foreach ([
            ...
            ['email' => 'pm@example.com', 'name' => 'E2E PM', 'role' => Role::ProductManagement, 'can_view_dispo_orders' => false],
            ['email' => 'pm-dispo@example.com', 'name' => 'E2E PM Dispo', 'role' => Role::ProductManagement, 'can_view_dispo_orders' => true],
            ...
            User::query()->updateOrCreate(
                ...
                [
                    ...
                    'password' => 'password',
                    'role' => $attrs['role'],
                    'can_view_dispo_orders' => $attrs['can_view_dispo_orders'] ?? false,
                ],
            );
        }
        ...
        $organization = Organization::factory()->create(['name' => 'E2E BL-P9-02a']);
        ...
        $list = PriceList::factory()->create([
            ...
            'year' => $year,
            'version' => 'e2e-blp902a-'.$inventory->code,
        ...
        $calc = $writer->create([
            ...
            'customer_name' => 'BLP902A Kommentar GmbH',
