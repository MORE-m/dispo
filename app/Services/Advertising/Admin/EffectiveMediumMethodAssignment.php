...
/**
 * ADV-001c3c: effektive Desired-State-Zeile für Medium-Methoden Preview/Apply.
 */
final readonly class EffectiveMediumMethodAssignment
{
    public function __construct(
        ...
        public ?AdvertisingMediumCalculationMethod $existing,
    ) {}
