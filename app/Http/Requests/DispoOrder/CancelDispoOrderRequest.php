...
class CancelDispoOrderRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'reason' => [
                'required',
                'string',
                'max:'.DispoOrderCancellationService::REASON_MAX,
            ],
        ];
    }
    ...
    {
        return [
            'reason.required' => 'Eine Begründung ist für die Stornierung erforderlich.',
        ...
        $validator->after(function (Validator $validator): void {
            ...
            if (trim($reason) === '') {
                $validator->errors()->add(
                    'reason',
                    'Eine Begründung ist für die Stornierung erforderlich.',
                );
            }
        });
    }
