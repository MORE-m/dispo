...
- **Phase:** 2
- **Status:** teilweise (`ADV-001a` Datenbasis; `ADV-001b` Katalog-Admin; `ADV-001c1` Methoden-Schema; `ADV-001c2` Dual-Read/Write + Freeze; `ADV-001c3a` engine-unabhängige Medienpflege; `ADV-001c3b1` Methoden-Lifecycle; c3b2/c3c und Positionsauswahl c4 offen)
