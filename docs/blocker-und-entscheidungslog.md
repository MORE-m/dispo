...
| 09.09.2026 | DF-3.3a2β Review-Härtung | Dispo-Freeze nur für ausgewählte Calc-Positionen; `deleteEffectiveIfUnreferenced` fail-closed bei Restreferenz; Gen-3-Integrity (Kontext ID/Key/Name, Parent-Basis, Ownership inkl. Owner-Basis); Fingerprint-Vertrag Create/kontextänderndes Update (422→409→fachliche 422); PO-32b-1 auch Header-Custom. **DF-3.3b bleibt Nicht-Ziel.** | VER-003, PO-32b-1, DF-3.3a2β |
