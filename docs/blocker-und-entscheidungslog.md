...
| BLK-006 | UX-GATE-D | Operative Disposition, Standardangebote, übrige Admin-Initialkataloge und Auswertungen nicht freigegeben. Teilfreigaben: Dispo/Vier-Augen; Dynamische-Felder-Admin (DF-3.1/DF-3.2a/b/DF-3.3-fs/DF-3.3a1 JSON-API). | Nur Sperrzustände für nicht freigegebene Module |
