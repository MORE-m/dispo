...
| 09.09.2026 | ADV-001b Locking-Härtung | Invariante „aktives Medium nie unter inaktiver Kategorie“. `CatalogLifecycleLockCoordinator`: Media nach id ASC, dann Kategorien nach id ASC (kompatibel zu `AssignmentConfigurationLockCoordinator`). Create/Change/Reactivate und Kategorie-Deakt. serialisieren über Zeilensperren; nach Kategorie-Lock erneuter Locking-Read gegen RR-Phantome; Impact-Preview erst nach Lock. MySQL-Paralleltests C-RACE-01..03. Keine Migration, kein Scope-Zuwachs. | ADV-001b, AUD-001 |
