...
/**
 * ADV-001b isolierte E2E-Suite: Katalog-Admin (eigene SQLite-DB, Port 8007).
 */
const e2eDb = path.resolve(
    path.dirname(fileURLToPath(import.meta.url)),
    'database/e2e-adv001b.sqlite',
);

const e2ePort = process.env.E2E_ADV001B_PORT ?? '8007';
