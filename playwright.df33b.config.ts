...
/**
 * DF-3.3b isolierte E2E-Suite: Assignment-Admin-UI (eigene SQLite-DB, Port 8006).
 */
const e2eDb = path.resolve(
    path.dirname(fileURLToPath(import.meta.url)),
    'database/e2e-df33b.sqlite',
);

const e2ePort = process.env.E2E_DF33B_PORT ?? '8006';
