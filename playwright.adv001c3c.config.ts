...
/**
 * ADV-001c3c isolierte E2E-Suite (eigene SQLite-DB, Port 8011).
 */
const e2eDb = path.resolve(
    path.dirname(fileURLToPath(import.meta.url)),
    'database/e2e-adv001c3c.sqlite',
);

const e2ePort = process.env.E2E_ADV001C3C_PORT ?? '8011';
