...
/**
 * BL-P2-01a isolierte E2E-Suite: Inventar-Admin-Lifecycle.
 * Eigene SQLite-DB, Port 8016 — niemals Dev-DB `dispo`.
 */
const e2eDb = path.resolve(
    path.dirname(fileURLToPath(import.meta.url)),
    'database/e2e-bl-p2-01a.sqlite',
);

const e2ePort = process.env.E2E_BLP201A_PORT ?? '8016';
